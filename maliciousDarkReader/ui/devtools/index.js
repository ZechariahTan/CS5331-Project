(function () {
    ...
    new Date().toLocaleTimeString(getUILanguage()).endsWith("M");
    ...
    const DEVTOOLS_DOCS_URL =
        "https://github.com/darkreader/darkreader/blob/master/CONTRIBUTING.md";
    ...
    function Body({data, actions}) {
        ...
        const wrapper =
            theme.engine === ThemeEngines.staticTheme
                ...
                : theme.engine === ThemeEngines.cssFilter ||
                  theme.engine === ThemeEngines.svgFilter
                ? {
        ...
        return m$1(
            ...
            m$1(
                ...
                m$1(
                    Button,
                    {class: "preview-design-button", onclick: toggleDesign},
                    previewButtonText
                )
            ),
            m$1(
    ...
    function renderBody(data, actions) {
        sync(document.body, m$1(Body$1, {data: data, actions: actions}));
    }
